...
git clone https://pfiller:${GH_TOKEN}@github.com/websitebloger/bower-chosen.git
rm -rf bower-chosen/*
...
git remote set-url origin https://pfiller:${GH_TOKEN}@github.com/websitebloger/bower-chosen.git
...
echo "Chosen published to websitebloger/bower-chosen"
